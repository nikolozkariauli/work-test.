# Boolean არის მონაცემთა ტიპი, რომელსაც მხოლოდ 2 ორი მდგომარეობა აქვს: True (ჭეშმარიტი) ან False (მცდარი)

# data type მონაცემთა ტიპები არის: str, int, float, bool.
...
is_super_gela = ("true")
print(is_super_gela != true)

# print(boolean(0))"es araa swori ai esaa swori"print(bool(0))
